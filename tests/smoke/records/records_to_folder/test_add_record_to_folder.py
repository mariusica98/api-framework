...
class TestAddRecordToFolderFlow:
    ...
    def test_add_record_to_folder_from_csf_page(self, folder_helper, record_helper, cleanup_context):
    ...
    def test_add_record_to_folder_from_record_page(self, folder_helper, record_helper, cleanup_context):
