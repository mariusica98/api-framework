...
class TestCreateCaseFlow:
    ...
    def test_create_case(self, case_helper, cleanup_context):
    ...
    def test_create_duplicate_case(self, case_helper, cleanup_context):
        ...
        with allure.step("Creating the first case"):
            ...
            cleanup_context["case_id"] = first_case_id
